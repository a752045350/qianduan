    ...
    <el-table
      ...
      <el-table-column label="操作" width="350" align="center">
        <template slot-scope="scope" >
          ...
          <router-link :to="'/teacher/chapter/'+scope.row.id">
...
export default {
    ...
    methods:{//创建具体 的方法，调用teacher.js定义的方法
    ...
    Draft(){
        ...
        getList(page = 1){
            this.page = page
            console.log("sssss",this.courseQuery)
            course.getCoursePagetList(this.page,this.limit,this.courseQuery)
            .then(response => {//请求成功
                //Response请求成功返回的数据
